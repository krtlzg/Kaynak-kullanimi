...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final MediaPlayer ses=createMedia(satir,hayvan);
    ...
    private MediaPlayer createMedia(View satir, SatirModel hayvan) {
        MediaPlayer ses=MediaPlayer.create(satir.getContext(),hayvan.getMediaId());
        return ses;
    }
